...
favSectionLabel.TextColor3 = C.white
...
refreshBtn.Position = UDim2.new(1, -120, 0.5, -9)
refreshBtn.BackgroundColor3 = C.black
refreshBtn.BackgroundTransparency = 0.2
refreshBtn.BorderSizePixel = 0
refreshBtn.Text = "Refresh"
refreshBtn.TextColor3 = C.buttonBlue
refreshBtn.Font = Enum.Font.GothamBold
refreshBtn.TextSize = 9
refreshBtn.AutoButtonColor = false
refreshBtn.Parent = favHeaderRow
...
refreshStroke.Color = C.buttonBlue
...
manageBtn.Size = UDim2.new(0, 55, 0, 18)
manageBtn.Position = UDim2.new(1, -60, 0.5, -9)
manageBtn.BackgroundColor3 = C.black
manageBtn.BackgroundTransparency = 0.2
...
manageBtn.AutoButtonColor = false
manageBtn.Parent = favHeaderRow

local manageCorner = Instance.new("UICorner")
manageCorner.CornerRadius = UDim.new(0, 5)
manageCorner.Parent = manageBtn

local manageStroke = Instance.new("UIStroke")
manageStroke.Thickness = 1
manageStroke.Color = C.subtitleGrey
manageStroke.Transparency = 0.5
manageStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
manageStroke.Parent = manageBtn
...
local manageView = Instance.new("Frame")
...
local function createManageRow(index, animalName, onRefresh)
    ...
    upBtn.Size = UDim2.new(0, 22, 0, 20)
    upBtn.Position = UDim2.new(1, -88, 0.5, -10)
    upBtn.BackgroundColor3 = C.black
    upBtn.BackgroundTransparency = 0.3
    upBtn.BorderSizePixel = 0
    upBtn.Text = "↑"
    upBtn.TextColor3 = C.buttonBlue
    ...
    upStroke.Color = C.buttonBlue
    upStroke.Transparency = 0.5
    upStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    upStroke.Parent = upBtn

    local downBtn = Instance.new("TextButton")
    downBtn.Size = UDim2.new(0, 22, 0, 20)
    downBtn.Position = UDim2.new(1, -63, 0.5, -10)
    downBtn.BackgroundColor3 = C.black
    downBtn.BackgroundTransparency = 0.3
    downBtn.BorderSizePixel = 0
    downBtn.Text = "↓"
    downBtn.TextColor3 = C.buttonBlue
    ...
    removeBtn.Position = UDim2.new(1, -35, 0.5, -10)
    removeBtn.BackgroundColor3 = C.black
    ...
    removeStroke.Color = C.red
    removeStroke.Transparency = 0.5
    removeStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
...
addRow.BackgroundColor3 = C.black
...
addBtn.BackgroundColor3 = C.coolBlue
...
manageBtn.MouseButton1Click:Connect(function()
    ...
    if manageActive then
        manageBtn.TextColor3 = C.buttonBlue
        manageStroke.Color = C.buttonBlue
