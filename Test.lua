...
-- [ALIH] Fungsi untuk membuat dropdown secara dinamik (dipindahkan ke bawah slider)
...
-- [TAMBAH] Load Full Map Toggle
local isLoadFullMapEnabled = false
...
local function enableLoadFullMap()
    if isLoadFullMapEnabled then return end
    
    isLoadFullMapEnabled = true
    forceRenderAll()
    
    -- Set quality level to max
...
local function disableLoadFullMap()
    isLoadFullMapEnabled = false
...
local LoadFullMapToggle = MiscTab:Toggle({
    Title = "Load Full Map",
    Desc = "Force render all parts and set graphics to maximum quality",
    Default = false,
    Callback = function(state)
        if state then
            enableLoadFullMap()
...
-- [TAMBAH] Auto Rebirth Toggle and Slider
...
local AutoRebirthToggle = MiscTab:Toggle({
    Title = "Auto Rebirth",
    Desc = "Automatically rebirth at set intervals",
    Default = false,
    Callback = function(state)
...
local AutoRebirthDelaySlider = MiscTab:Slider({
...
myConfig:Register("LoadFullMap", LoadFullMapToggle) -- [TAMBAH]
myConfig:Register("AutoRebirth", AutoRebirthToggle) -- [TAMBAH]
myConfig:Register("AutoRebirthDelay", AutoRebirthDelaySlider) -- [TAMBAH]
