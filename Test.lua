...
local autoStealMode = "nearest" -- "nearest" or "best"
...
Nightmare:AddToggleRow("Unwalk Anim", toggleUnwalkAnim, "Nearest", toggleAutoSteal)
Nightmare:AddToggleRow("Best Gen", toggleBestGen, "Anti Debuff", toggleAntiDebuff)
