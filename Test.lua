--[[
    NIGHTMARE UI - INTEGRASI ESP PLAYERS, ESP BEST, BASE LINE, ANTI TURRET, AIMBOT, KICK STEAL, UNWALK ANIM, NEAREST, ANTI DEBUFF, ANTI RDOLL & XRAY BASE
]]
...
local function toggleXrayBase(state) if state then enableXrayBase() else disableXrayBase() end
...
Nightmare:AddToggleRow("Xray Base", toggleXrayBase, "", nil)

print("🎮 Nightmare UI with ESP, Base Line, Anti Turret, Aimbot, Kick Steal, Unwalk Anim, Nearest, Anti Debuff, Anti Rdoll & Xray Base Loaded Successfully!")
