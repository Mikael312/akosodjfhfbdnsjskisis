...
mainFrame.Size = UDim2.new(0, 200, 0, 290) -- DIKURANGKAN KERANA FLY TELAH DIBUANG
mainFrame.Position = UDim2.new(0.5, -100, 0.5, -145) -- DISESUAIKAN UNTUK CENTERING BARU
...
local function createToggleButton(parent, name, text, position, size)
    ...
    button.Name = name
    button.Size = size or UDim2.new(0, 170, 0, 32)
...
local toggleButton = createToggleButton(mainFrame, "PermDesync", "Perm Desync", UDim2.new(0.5, -85, 0, 20), UDim2.new(0, 170, 0, 32))
...
local toggleButton2 = createToggleButton(mainFrame, "SpeedBooster", "Speed Booster", UDim2.new(0.5, -85, 0, 60), UDim2.new(0, 170, 0, 32))
...
local toggleButton3 = createToggleButton(mainFrame, "InfJump", "Inf Jump", UDim2.new(0.5, -85, 0, 100), UDim2.new(0, 170, 0, 32))
...
local devourerToggleButton = createToggleButton(mainFrame, "FpsDevourer", "Fps Devourer", UDim2.new(0, 20, 0, 140), UDim2.new(0, 125, 0, 32))
local isDevourerToggled = false

-- Small TP Button
local tpButton = createSwitchButton(mainFrame, "TPButton", "TP", UDim2.new(0, 153, 0, 140), UDim2.new(0, 30, 0, 32))

-- Devourer Toggle Function
devourerToggleButton.MouseButton1Click:Connect(function()
    isDevourerToggled = not isDevourerToggled
    setToggleState(devourerToggleButton, isDevourerToggled)
...
-- Main button
local toggleButton6 = createToggleButton(mainFrame, "FlyTpBest", "Fly to Best", UDim2.new(0, 20, 0, 180), UDim2.new(0, 125, 0, 32))

-- Switch Button
local switchButton6 = createSwitchButton(mainFrame, "SwitchButton", "⇄", UDim2.new(0, 153, 0, 180), UDim2.new(0, 30, 0, 32))
...
local toggleButton5 = createToggleButton(mainFrame, "StealFloor", "Steal Floor", UDim2.new(0.5, -85, 0, 220), UDim2.new(0, 170, 0, 32))
