--[[
    NIGHTMARE UI - INTEGRASI ESP PLAYERS, ESP BEST, BASE LINE, ANTI TURRET, AIMBOT, KICK STEAL, UNWALK ANIM, SMART STEAL & ANTI DEBUFF
]]
...
local function toggleSmartSteal(state)
    ...
    if state then
        createStealUI()
        startAutoSteal()
        print("✅ Smart Steal Enabled")
    else
        stopAutoSteal()
        destroyStealUI()
        print("❌ Smart Steal Disabled")
    end
end
...
Nightmare:AddToggleRow("Unwalk Anim", toggleUnwalkAnim, "Smart Steal", toggleSmartSteal)
Nightmare:AddToggleRow("Anti Debuff", toggleAntiDebuff, "", nil)

print("🎮 Nightmare UI with ESP, Base Line, Anti Turret, Aimbot, Kick Steal, Unwalk Anim, Smart Steal & Anti Debuff Loaded Successfully!")
