...
-- ==================== AUTO STEAL FUNCTIONS (NEW INTEGRATED) ====================
...
local function createStealUI()
    if stealScreenGui then return end -- Already created

    stealScreenGui = Instance.new("ScreenGui")
    stealScreenGui.Name = "StealBar"
    stealScreenGui.ResetOnSpawn = false
    stealScreenGui.Parent = getSafeCoreGuiParent()
    stealScreenGui.Enabled = false -- Start hidden
    ...
    mainFrame.Parent = stealScreenGui
...
local function animateFill()
    if isAnimating or not fillBar or not percentLabel then return end 
    isAnimating = true
...
Nightmare:AddToggleRow("Unwalk Anim", toggleUnwalkAnim, "Auto Steal", toggleAutoSteal) -- Updated to reflect new functionality
