...
local devourerToggleButton = createToggleButton(mainFrame, "FpsDevourer", "Fps Devourer", UDim2.new(0, 15, 0, 140), UDim2.new(0, 115, 0, 32)) -- Saiz & posisi disesuaikan
local isDevourerToggled = false

-- Small TP Button
local tpButton = createSwitchButton(mainFrame, "TPButton", "TP", UDim2.new(0, 135, 0, 140), UDim2.new(0, 30, 0, 32)) -- Posisi disesuaikan
...
-- Main button
local toggleButton6 = createToggleButton(mainFrame, "FlyTpBest", "Fly to Best", UDim2.new(0, 15, 0, 180), UDim2.new(0, 115, 0, 32)) -- Saiz & posisi disesuaikan

-- Switch Button
local switchButton6 = createSwitchButton(mainFrame, "SwitchButton", "⇄", UDim2.new(0, 135, 0, 180), UDim2.new(0, 30, 0, 32)) -- Posisi disesuaikan
