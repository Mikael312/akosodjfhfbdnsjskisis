...
local BrainrotUpgradeModeDropdown = AutoTab:Dropdown({
    ...
    Values = {
        ...
        {Title = "Slot 1", Icon = "numeric-1"},
        {Title = "Slot 2", Icon = "numeric-2"},
        {Title = "Slot 3", Icon = "numeric-3"},
        {Title = "Slot 4", Icon = "numeric-4"},
        {Title = "Slot 5", Icon = "numeric-5"},
        {Title = "Slot 6", Icon = "numeric-6"},
        {Title = "Slot 7", Icon = "numeric-7"},
        {Title = "Slot 8", Icon = "numeric-8"},
        {Title = "Slot 9", Icon = "numeric-9"},
        {Title = "Slot 10", Icon = "numeric-10"},
    },
    Value = "All",
    Callback = function(option)
