--[[
    ...
    UPDATED: Added Invisible V2 toggle to Main tab.
]]
...
-- Invisible V2 Variables (NEW)
local invisibleV2Enabled = false
...
-- ==================== INVISIBLE V2 FUNCTION (NEW) ====================
local function toggleInvisibleV2(state)
    if state then
...
player.CharacterAdded:Connect(function(newCharacter)
    ...
    if invisibleV2Enabled then
        task.wait(1)
        toggleInvisibleV2(false)
        toggleInvisibleV2(true)
        print("🔄 Reloaded Invisible V2 after respawn")
    end
end)
...
-- MAIN TAB (8 TOGGLES - Changed Invisible V1 to Semi Invisible, Added Auto Kick After Steal, Added Invisible V2)
tabContent["Main"] = {}
...
table.insert(tabContent["Main"], createToggleButton("Invisible V2", function(state)  -- NEW: Added Invisible V2
    invisibleV2Enabled = state
    toggleInvisibleV2(state)
end))
...
print("✅ ADDED: Invisible V2 toggle in Main tab.")
