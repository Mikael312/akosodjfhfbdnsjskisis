...
-- MISC TAB (6 TOGGLES - Added Grapple Speed, Anti Knockback, Anti Ragdoll, Anti Trap, and Unwalk Anim)
tabContent["Misc"] = {}
...
table.insert(tabContent["Misc"], createToggleButton("Unwalk Anim", function(state)
    toggleUnwalkAnim(state)
end))
...
serverBtn.BackgroundColor3 = Color3.fromRGB(80, 0, 0)
serverBtn.BorderSizePixel = 0
serverBtn.Text = "Join Server"
serverBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
serverBtn.TextSize = 14
serverBtn.Font = Enum.Font.Arcade
...
serverStroke.Color = Color3.fromRGB(255, 50, 50)
serverStroke.Thickness = 1
serverStroke.Parent = serverBtn

serverBtn.MouseButton1Click:Connect(function()
    setclipboard("https://www.roblox.com/games/your-game-id")
    serverBtn.Text = "COPIED!"
    serverBtn.BackgroundColor3 = Color3.fromRGB(0, 150, 0)
    task.wait(2)
    serverBtn.Text = "Join Server"
    serverBtn.BackgroundColor3 = Color3.fromRGB(80, 0, 0)
end)

table.insert(tabContent["Discord"], serverBtn)
...
print("✅ ADDED: Unwalk Anim toggle in Misc tab.")
print("✅ ADDED: Server section in Discord tab.")
