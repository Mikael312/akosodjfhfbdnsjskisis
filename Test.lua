...
mainFrame.Size = UDim2.new(0, 180, 0, 320) -- DITAMBAH UNTUK RUANG FLY V1
mainFrame.Position = UDim2.new(1, -290, 0.5, -184) -- KEDUDUKAN BAHARU
...
-- ==================== NEW FLY V1 TOGGLE BUTTON ====================
-- Toggle Button 7 - Fly V1
local toggleButton7 = createToggleButton(mainFrame, "FlyV1", "Fly V1", UDim2.new(0.5, -80, 0, 220), UDim2.new(0, 160, 0, 32))
