...
mainFrame.Size = UDim2.new(0, 180, 0, 320) -- DITAMBAH UNTUK RUANG FLY V2
...
-- Toggle Button 7 - Fly V2
local toggleButton7 = createToggleButton(mainFrame, "FlyV2", "Fly V2", UDim2.new(0.5, -80, 0, 220), UDim2.new(0, 160, 0, 32))
