--[[
    ...
    WITH NEW GRAPPLE FLY TOGGLE (INTEGRATED)
]]
...
local function toggleGrappleFly(state)
    ...
    if not (char and humanoid and rootPart) then
        return
    end
    ...
    -- Grapple Hook Auto-Fire
    grappleFlyGrappleConn = RunService.Heartbeat:Connect(function()
        if not grappleFlyActive then return end
    ...
    -- Movement Control (IY Style - Camera Following) - LOCKED AT 160 SPEED
    grappleFlyRenderConn = RunService.RenderStepped:Connect(function()
        if not grappleFlyActive then return end
        ...
        -- PC keyboard controls (based on camera direction)
        if not IsOnMobile then
            ...
            -- Mobile up/down (can add UI buttons if needed)
            if UserInputService:IsKeyDown(Enum.KeyCode.Space) then
                move = move + Vector3.new(0, 1, 0)
            end
        end
        
        -- Create BodyMovers if they don't exist
        ...
        -- Character faces camera direction (IY Style)
...
mainFrame.Size = UDim2.new(0, 200, 0, 360) -- DITAMBAH DARI 320 JADI 360 UNTUK RUANG LEBIH
mainFrame.Position = UDim2.new(0.5, -100, 0.5, -180) -- DISESUAIKAN UNTUK CENTERING BARU (360/2 = 180)
...
tpButton.BackgroundColor3 = Color3.fromRGB(80, 0, 0) -- Changed to requested color
...
toggleButton6.Position = UDim2.new(0, 20, 0, 210) -- DI ALIHKAN KE ATAS
...
switchButton6.Position = UDim2.new(0, 153, 0, 210) -- DI ALIHKAN KE ATAS
...
toggleButton5.Position = UDim2.new(0.5, -80, 0, 250) -- DI ALIHKAN KE ATAS
...
-- ==================== NEW FLY TOGGLE ====================
-- Toggle Button 4 - Fly (DIALIHKAN KE BAWAH)
local toggleButton4 = Instance.new("TextButton")
toggleButton4.Size = UDim2.new(0, 160, 0, 32)
toggleButton4.Position = UDim2.new(0.5, -80, 0, 290) -- DIALIHKAN KE BAWAH
toggleButton4.BackgroundColor3 = Color3.fromRGB(80, 0, 0)
toggleButton4.BorderSizePixel = 0
toggleButton4.Text = "Fly"
toggleButton4.TextColor3 = Color3.fromRGB(255, 255, 255)
toggleButton4.TextSize = 16
...
contentLabel.Position = UDim2.new(0, 20, 0, 330) -- DISESUAIKAN
