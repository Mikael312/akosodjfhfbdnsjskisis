...
-- ============================================================
-- ABSOLUTE ANTI RAGDOLL SYSTEM - COMBINED DUAL METHOD (NEW)
-- ============================================================
...
local function setupCharacter(char)
    ...
    print("[Absolute Anti Ragdoll] Reloaded both methods after respawn")
end
...
local function enableAbsoluteAntiRagdoll()
    ...
    print("[Absolute Anti Ragdoll] Enabled - Dual protection active")
end
...
local function disableAbsoluteAntiRagdoll()
    ...
    print("[Absolute Anti Ragdoll] Disabled")
end
